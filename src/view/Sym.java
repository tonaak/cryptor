...
public class Sym extends JFrame {
	...
	public Sym() {
		...
		logo.setIcon(new ImageIcon(Sym.class.getResource("/image/encrypted-data.png")));
		...
		btnReturn.setIcon(new ImageIcon(Sym.class.getResource("/image/return.png")));
...
//				timer.start();
		...
		btnFile.setIcon(new ImageIcon(Sym.class.getResource("/image/file.png")));
		...
		btnText.setIcon(new ImageIcon(Sym.class.getResource("/image/text-box.png")));
